...
public class SimulationTest {
    ...
    public void testSimulation() {
        ...
        Simulation simulation = new Simulation(iterations, numCreatures, horizonWidth);
        simulation.run();
    ...
    public void simFlashTest(int iterations, int numCreatures, int horizonWidth, Exception expectedException) {
    ...
    static Stream<Arguments> generator() {
        return Stream.of(
                ...
                of(-15, 5, 1000, new IllegalArgumentException()) // T4 ITERATIONS < 0
        );
    }
